...
class Player(object):
    def __init__(self, position, color, color_lines, speed, color_info):
        ...
        self.way_angle = None
        self.work_info = pygame.font.SysFont(None, 24)
    ...
    def draw(self, mouse):
        ...
        if self.way_angle:
            ...
            angle_text = self.work_info.render(str(way_angle_degrees), False, self.color_info)
            self.window.blit(angle_text, (20, 20))
